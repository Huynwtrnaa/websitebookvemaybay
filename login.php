...
if(isset($_GET['pwd'])) {
    if($_GET['pwd']=='updated') {
        echo "<script>alert('Mật khẩu đã đc reset!!');</script>";
    }
}    
?>
<?php
if(isset($_GET['error'])) {
    if($_GET['error'] === 'invalidcred') {
        ...
        echo"<script>alert('Lỗi csdl')</script>";
    }
}
...
<div class="container mt-0">
  <div class="row">
    <div class="col-md-3"></div>
      ...
      <h1 class="text-secondary text-center">Đăng nhập</h1>
      ...
      <form method="POST" class=" text-center" 
        ...
        <div class="row mt-3">
          ...
          <a id="reset-pass" class="mr-5" href="reset-pwd.php"
              style="float: right !important;">Đổi mật khẩu</a>        
          </div>         
        </div>   
        <div class="row mt-4">
          <div class="col">
            <a href="register.php">
              <button type="button" class="btn btn-info mt-3">
                ...
                <i class="fas fa-user-plus text-light"></i> Đăng ký
                </div>
              </button>
            </a> 
          </div> 
          <div class="col">
            <button name="login_but" type="submit" 
              ...
              <div style="font-size: 1.5rem;">
              <i class="fa fa-lg fa-arrow-right"></i> Đăng nhập
              </div>
            </button>
          </div>       
        </div>       
